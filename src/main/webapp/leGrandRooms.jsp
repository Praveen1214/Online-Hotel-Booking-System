...
<title>Le Grand Hotel | Colombo</title>
...
<body>
		...
		<br><br>
		<div class="table1">
		<h2>Le Grand Hotel</h2>
		<p><img src="images/locationIcon.png" width="20">&nbsp;No.30, Park Road, Kaluwalla, , 80000 Galle, Sri Lanka</p>
		<table>
			<tr class="table1">
				<td><img alt="" src="images/legraPic.jpg" width=500></td>
				<td width="500"><p class="ph1">You're eligible for a Genius discount at Le Grand Galle By Asia Leisure! To save at this property, all you have to do is sign in.

Set in Galle, 300 metres from Galle International Cricket Stadium, Le Grand Galle By Asia Leisure has a number of amenities including an outdoor swimming pool, a fitness centre, a garden and free WiFi. The property is situated 600 metres from Dutch Church Galle, a 9-minute walk from Galle Fort and 1.1 km from Galle Light house. The property is 600 metres from Galle Fort National Museum.

From a spectacular view of the ocean and the iconic UNESCO Heritage site, Galle Fort to invigorating architecture, plush interiors, lavish suites with private plunge pools and the finest-in-class service, Le Grand is truly yours.<br><br>
...
The daily breakfast offers continental, buffet or Full English/Irish options. The restaurant at the hotel specialises in seafood, international and local cuisine.<br><br>

Le Grand Galle By Asia Leisure offers a hot tub. Cycling is among the activities that guests can enjoy near the accommodation.

Speaking Japanese and English staff will be happy to provide guests with practical information on the area at the reception.

Galle Fort Clock Tower is a 4-minute walk from Le Grand Galle By Asia Leisure, while Mahendra Amarasooriya Park is 500 metres away.</p>
		...
		<b><p style="margin-left: 258px;color:#0c883d">Arrival date :- </p></b><br><input type="date" name="arrivalDate"required style="border:none;margin-left:260px;width:200px;height:30px;"><br><br>
		...
		<center><table class="sleep" border="1" width="66%">
			...
			<tr>
				...
				<td width="200" ><b><p  style="position:relative;bottom:100px;margin-left:20px;">LKR 21,278</p></td>
				<td width="300" >
				...
				<td width="100" >
					...
					<select id="singleRoomSelect" onchange="updateTotal()" style="position:relative;bottom:95px;border:none;">
					    ...
					    <option value="1">1 (LKR 21,278)</option>
					    <option value="2">2 (LKR 42,556)</option>
					    <option value="3">3 (LKR 63,834)</option> 
					    <option value="4">4 (LKR 85,112)&nbsp;&nbsp;</option>
			...
			<tr>
				...
				<td width="200" ><b><p  style="position:relative;bottom:100px;margin-left:20px;">LKR 43,555</p></td>
				<td width="300" >
				...
				<td width="100" >
					 <select id="doubleRoomSelect" onchange="updateTotal()" style="position:relative;bottom:95px;border:none;">
					    <option value="0">0</option>
					    <option value="1">1 (LKR 43,555)</option>
					    <option value="2">2 (LKR 87,110)</option>
					    <option value="3">3 (LKR 130,665)</option>
		...
		<script>
				  ...
				  function updateTotal() {
				    ...
				    var singleRoomAmount = singleRoomSelect.value * 21278; 
				
				   
				    var doubleRoomSelect = document.getElementById('doubleRoomSelect');
				    var doubleRoomAmount = doubleRoomSelect.value * 43555; 
