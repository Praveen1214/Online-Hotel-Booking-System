...
<style>
    ...
    table {
        ...
        margin-bottom: 20px;
        border: 3px solid black; /* Strong border for table */
    }

    th, td {
        border: 2px solid #000; /* Stronger borders for th and td */
        text-align: left;
    ...
    input[type="button"] {
        ...
        padding: 12px 20px; /* Increased padding for better button appearance */
        cursor: pointer;
