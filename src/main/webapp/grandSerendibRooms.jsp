...
<title>Grand Serendib Hotel | Colombo</title>
...
<body>
		...
		<br><br>
		<div class="table1">
		<h2>Grand Serendib Hotel</h2>
		<p><img src="images/locationIcon.png" width="20">&nbsp;Serendip Stone Bunglow ,Natherapotha,Bamunu Pola Road,Kundasale ,Kandy, 20168 Kandy, Sri Lanka</p>
		<table>
			<tr class="table1">
				<td><img alt="" src="images/serendipPic.jpg" width=500></td>
				<td width="500"><p class="ph1">You're eligible for a Genius discount at Serendip Stone Hotel and Bungalow! To save at this property, all you have to do is sign in.

Offering an indoor pool, Serendip Stone Bungalow is located in Kandy. Free WiFi access is available. Nattarampotha Junction Bus Station is 200 metres away.

Each room here will provide you with a TV and a balcony. Featuring a shower, private bathroom also comes with a hairdryer. You can enjoy river view and pool view from the room. Extras include a sofa, a desk and ironing facilities.<br><br>

At Serendip Stone Bungalow you will find a 24-hour front desk. Other facilities offered at the property include a shared lounge. An array of activities can be enjoyed on site or in the surroundings, including hiking. The property offers free parking.

The hotel is 3 km from Lakeside Adventist Hospital, 3.5 km from Kandy Museum and 3.5 km from Sri Dalada Maligawa. The Kandy Railway Station is 7.7 km away while Bandaranaike International Airport is 108 km away.</p>
		...
		<center><table class="sleep" border="1" width="66%">
			...
			<tr>
				...
				<td width="200" ><b><p  style="position:relative;bottom:100px;margin-left:20px;">LKR 20,100</p></td>
				<td width="300" >
					<img src="images/Breakfast-Icon.png"width="20" style="margin-left:20px;position:relative;bottom:10px;">&nbsp;<b><p  style="position:relative;bottom:35px;left:48px;font-size:13px;">Good</p></b><p style="font-size:13px;position:relative;left:85px;bottom:52px;">breakfast LKR 2,592</p>
				...
				<td width="100" >
					...
					<select id="singleRoomSelect" onchange="updateTotal()" style="position:relative;bottom:95px;border:none;">
					    ...
					    <option value="1">1 (LKR 20,100)</option>
					    <option value="2">2 (LKR 40,200)</option>
					    <option value="3">3 (LKR 60,300)</option> 
					    <option value="4">4 (LKR 80,400)&nbsp;&nbsp;</option>
			...
			<tr>
				...
				<td width="200" ><b><p  style="position:relative;bottom:100px;margin-left:20px;">LKR 41,200</p></td>
				<td width="300" >
					<img src="images/Breakfast-Icon.png"width="20" style="margin-left:20px;position:relative;bottom:10px;">&nbsp;<b><p  style="position:relative;bottom:35px;left:48px;font-size:13px;">Good</p></b> <p style="font-size:13px;position:relative;left:85px;bottom:52px;">breakfast LKR 5,000</p>
				...
				<td width="100" >
					 <select id="doubleRoomSelect" onchange="updateTotal()" style="position:relative;bottom:95px;border:none;">
					    <option value="0">0</option>
					    <option value="1">1 (LKR 41,200)</option>
					    <option value="2">2 (LKR 82,400)</option>
					    <option value="3">3 (LKR 123,600)</option>
			...
			<script>
				  ...
				  function updateTotal() {
				    ...
				    var singleRoomAmount = singleRoomSelect.value * 20100; 
				
				   
				    var doubleRoomSelect = document.getElementById('doubleRoomSelect');
				    var doubleRoomAmount = doubleRoomSelect.value * 41200; 
