...
<title>Heritance Hotel | Colombo</title>
...
<body>
		...
		<br><br>
		<div class="table1">
		<h2>Heritance Hotel</h2>
		<p><img src="images/locationIcon.png" width="20">&nbsp;No. 175, Lewis Place, 11500 Negombo, Sri Lanka</p>
		<table>
			<tr class="table1">
				<td><img alt="" src="images/heriPic.jpg" width=500></td>
				<td width="500"><p class="ph1">You're eligible for a Genius discount at Heritance Negombo! To save at this property, all you have to do is sign in.

Offering an outdoor pool, Heritance Negombo is located 2.1 km from St Anthony's Church and a 40-minute drive away from Colombo. Free WiFi access is available and rooms come equipped with a mini fridge.

Offering views of the Indian Ocean, every room includes a flat-screen cable TV. A hairdryer and bathrobes are provided in the en suite bathroom. Extras include a sofa, a desk and ironing facilities.<br><br>

The property offers several dining options ranging from seafood dinners on the lawn overlooking the ocean to breath taking elevated views from the See Lounge.

At Heritance Negombo you will find a fitness centre. Other facilities offered at the property include a tour desk and free parking.<br><br>

The hotel is just 100 metres from Negombo Beach Park while Bandaranaike International Airport is 20- minute drive away.</p>
		...
		<center><table class="sleep" border="1" width="66%">
			...
			<tr>
				...
				<td width="200" ><b><p  style="position:relative;bottom:100px;margin-left:20px;">LKR 18,710</p></td>
				<td width="300" >
					<img src="images/Breakfast-Icon.png"width="20" style="margin-left:20px;position:relative;bottom:10px;">&nbsp;<b><p  style="position:relative;bottom:35px;left:48px;font-size:13px;">Good</p></b><p style="font-size:13px;position:relative;left:85px;bottom:52px;">breakfast LKR 3,880</p>
				...
				<td width="100" >
					...
					<select id="singleRoomSelect" onchange="updateTotal()" style="position:relative;bottom:95px;border:none;">
					    ...
					    <option value="1">1 (LKR 18,710)</option>
					    <option value="2">2 (LKR 37,420)</option>
					    <option value="3">3 (LKR 56,130)</option> 
					    <option value="4">4 (LKR 74,840)&nbsp;&nbsp;</option>
			...
			<tr>
				...
				<td width="200" ><b><p  style="position:relative;bottom:100px;margin-left:20px;">LKR 38,420</p></td>
				<td width="300" >
				...
				<td width="100" >
					 <select id="doubleRoomSelect" onchange="updateTotal()" style="position:relative;bottom:95px;border:none;">
					    <option value="0">0</option>
					    <option value="1">1 (LKR 38,420)</option>
					    <option value="2">2 (LKR 76,840)</option>
					    <option value="3">3 (LKR 115,260)</option>
		...
		<script>
				  ...
				  function updateTotal() {
				    ...
				    var singleRoomAmount = singleRoomSelect.value * 18710; 
				
				   
				    var doubleRoomSelect = document.getElementById('doubleRoomSelect');
				    var doubleRoomAmount = doubleRoomSelect.value * 38420; 
